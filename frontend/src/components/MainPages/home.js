      ...
      <div>
        ...
        <div>
          ...
          <Pillars
            ...
            name={"Family"}
            description={
              "Promoting friendship and collaboration between fraternity members, family is one of the three key pillars of Theta Tau. Members of Theta Tau forge tightly-knit relationships through various brotherhood events, including socials, retreats, and friendly competition."
            }
          />
        </div>
        <div>
